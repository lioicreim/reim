...
export function generateFilterCode(options) {
  const {
    ...
    soundSettings = {}, // 사용자가 설정한 사운드 매핑 (localStorage에서 전달)
  ...
  // 화폐 규칙 생성
  generateCurrencyRules(lines, preset, customCurrencyTiers, leagueKey, soundContext, excludedItems["currency"] || [], lang);
